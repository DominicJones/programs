...
void print_range (char* name, int mrow, int* row);
void print_graph (char* name, int mrow, int* row, int* col);
void print_igraph (char* name, int mrow, int* idx, int* row, int* col);
