/**
 * order-dependent hash generation taken from the D runtime library
 *
 * to run:
 *   $ dmd -unittest -run hash.d
 */
...
unittest {
  ...
  foreach(i, ref e; lst1) {
    hash1 = hashOf(&e, int.sizeof, hash1);
  }
  ...
  foreach(i, ref e; lst1) {
    hash2 = hashOf(&e, int.sizeof, hash2);
  }
